    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">{t('NewsHub')}</h1>
            </div>
              ...
              <div className="flex items-center space-x-2 mr-4">
                <button 
                  ...
                  className={`w-8 h-6 rounded-sm overflow-hidden border transition-colors ${
                    i18n.language === 'en' ? 'border-blue-500' : 'border-gray-200 hover:border-blue-500'
                  }`}
                  title="English (Kenya)"
                >
                  <img 
                ...
                <button 
                  ...
                  className={`w-8 h-6 rounded-sm overflow-hidden border transition-colors ${
                    i18n.language === 'so' ? 'border-blue-500' : 'border-gray-200 hover:border-blue-500'
                  }`}
                  title="Somali"
                >
                  <img 
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {featuredArticle && activeCategory === 'All' && (
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('Featured Story')}</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            {activeCategory === 'All' ? t('Latest News') : `${t(activeCategory)} News`}
          </h2>
